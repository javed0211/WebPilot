...
export const AUTOMATION_EXERCISE_CANONICAL_PATHS = new Set([
  'framework/pages/automationexercise/AutomationExerciseBasePage.ts',
  'framework/pages/automationexercise/AutomationExerciseHomePage.ts',
  'framework/pages/automationexercise/AutomationExerciseProductsPage.ts',
  'framework/pages/automationexercise/AutomationExerciseCartPage.ts',
  'framework/pages/automationexercise/AutomationExerciseContactUsPage.ts',
]);
...
export const CANONICAL_PAGE_CONTENT: Record<string, string> = {
  'framework/pages/automationexercise/AutomationExerciseBasePage.ts': AUTOMATION_EXERCISE_BASE_PAGE,
  'framework/pages/automationexercise/AutomationExerciseHomePage.ts': AUTOMATION_EXERCISE_HOME_PAGE,
  'framework/pages/automationexercise/AutomationExerciseProductsPage.ts': AUTOMATION_EXERCISE_PRODUCTS_PAGE,
  'framework/pages/automationexercise/AutomationExerciseCartPage.ts': AUTOMATION_EXERCISE_CART_PAGE,
  'framework/pages/automationexercise/AutomationExerciseContactUsPage.ts': AUTOMATION_EXERCISE_CONTACT_US_PAGE,
};

export const CANONICAL_SPEC_BY_SLUG: Record<string, { path: string; content: string }> = {
  automationexercise_contact_us: {
    path: 'framework/tests/contact-us-form.spec.ts',
