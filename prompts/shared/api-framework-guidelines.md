...
- Generated clients under `framework/apis/*` compose `BaseAPI` from the `apiClient` fixture.

## Generated layout
| Artifact | Path |
|----------|------|
| API client | `framework/apis/<Name>Api.ts` |
| Playwright spec | `framework/tests/api/<slug>.api.spec.ts` |
...
npx playwright test framework/tests/api --config=framework/playwright.config.ts
```
